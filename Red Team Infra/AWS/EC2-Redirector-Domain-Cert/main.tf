...
data "cloudflare_zone" "redirector_domain" {
...
module "cloudflare_redirector_record" {

  source       = "./modules/cloudflare_dns"
  zone_id      = data.cloudflare_zone.redirector_domain.zone_id
  record_type  = "A"
  record_name  = "@"
  record_value = module.redirector_ec2.ec2_public_ip
  ttl          = 1
  proxied      = true
}
